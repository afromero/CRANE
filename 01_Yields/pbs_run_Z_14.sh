...
#
export PBS_O_WORKDIR=/halo_nobackup/eva/romerowo/crpropa_production_run_outputs/20161026/Z_14

# Set your input directory (optional)
#
export INPUT_DIR=/halo_nobackup/eva/romerowo/crpropa_production_run_inputs/20161026/Z_14
